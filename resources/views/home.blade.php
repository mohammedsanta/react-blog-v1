                ...
                <div class="owl-carousel main-carousel position-relative">
                    @foreach($posts3 as $post)
                        ...
                        <div class="position-relative overflow-hidden" style="height: 500px;">
                            <img class="img-fluid h-100" src="{{ Storage::Url($post->picture) }}" style="object-fit: cover;">
                            <div class="overlay">
                                <div class="mb-2">
                                ...
                                <a class="h2 m-0 text-white text-uppercase font-weight-bold" href="{{ route('post.show',$post->id) }}">{{ $post->title }}</a>
                            </div>
                        </div>
                ...
                <div class="row mx-0">
                    ...
                    <div class="col-md-6 px-0">
                        <div class="position-relative overflow-hidden" style="height: 250px;">
                            <img class="img-fluid w-100 h-100" src="{{ Storage::Url($post->picture) }}" style="object-fit: cover;">
                            <div class="overlay">
                                <div class="mb-2">
                                    <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 mr-2"
                                        href="">{{ $post->tag->tag }}</a>
                                ...
                                <a class="h6 m-0 text-white text-uppercase font-weight-semi-bold" href="{{ route('post.show',$post->id) }}">{{ $post->title }}</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="bg-white text-center border border-top-0 p-3">
                            <a href=""><img class="img-fluid" src="{{ Storage::Url('/pictures/ads.png') }}" alt=""></a>
                        </div>
                    </div>
                    <!-- Ads End -->
